    ...
    <>
      ...
      <a className="floating-wa" href={whatsappHref} target="_blank" rel="noreferrer" aria-label="Chat via WhatsApp">
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="M19.1 4.9A9.96 9.96 0 0 0 3.5 17l-1.3 4.8L7 20.6a9.95 9.95 0 0 0 14-8.7 9.88 9.88 0 0 0-1.9-7ZM12 20a8 8 0 0 1-4.1-1.1l-.3-.2-2.8.8.8-2.7-.2-.3A8 8 0 1 1 12 20Zm4.4-6c-.2-.1-1.2-.6-1.4-.7-.2-.1-.3-.1-.5.1-.1.2-.6.7-.7.8-.1.1-.3.1-.5 0-1.3-.7-2.2-1.9-2.4-2.2-.1-.2 0-.3.1-.4l.4-.4.2-.4a.4.4 0 0 0 0-.4c-.1-.1-.5-1.2-.7-1.6-.2-.4-.4-.3-.5-.3h-.4a.8.8 0 0 0-.6.3c-.2.2-.8.8-.8 1.9s.8 2.2.9 2.3c.1.2 1.6 2.5 3.9 3.4.5.2 1 .4 1.4.5.6.2 1.1.2 1.5.1.5-.1 1.2-.5 1.4-.9.2-.5.2-.9.1-.9 0-.1-.2-.2-.4-.3Z" />
        </svg>
      </a>
